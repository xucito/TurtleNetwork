  ...
  test("exchange tx with orders v3") {
    ...
    for ((o1ver, o2ver, matcherFeeOrder1, matcherFeeOrder2) <- Seq(
      ...
      if (matcherFeeOrder1 == Waves && matcherFeeOrder2 != Waves) {
        ...
        sender.transfer(buyer.stringRepr, seller.stringRepr, 2000000, minFee, Some(assetId.base58), waitForTx = true)
      }

      val buyPrice   = 500000
      val sellPrice  = 500000
      val buyAmount  = 400000000
      val sellAmount = 400000000
