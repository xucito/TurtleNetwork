...
class MatcherTestSuite extends MatcherSuiteBase with TableDrivenPropertyChecks {
  ...
  "Check cross ordering between Alice and Bob" - {
    ...
    val order1         = matcherNode.prepareOrder(aliceAcc, aliceWavesPair, SELL, aliceSellAmount, 2000.TN, version = orderVersion, timeToLive = 2.minutes)
    ...
    "sell order could be placed correctly" - {
      ...
      "and should match with buy order" in {
        ...
        val order2 = matcherNode.placeOrder(bobAcc, aliceWavesPair, BUY, 200, 2.TN * Order.PriceConstant, matcherFee, orderVersion)
      ...
      "submitting sell orders should check availability of asset" in {
        ...
        val badOrder = matcherNode.prepareOrder(bobAcc, aliceWavesPair, SELL, 300, 1900.TN, orderVersion)
        ...
        val order3 = matcherNode.placeOrder(bobAcc, aliceWavesPair, SELL, 150, 1900.TN, matcherFee, orderVersion)
      ...
      "buy order should match on few price levels" in {
        ...
        val order4 =
          matcherNode.placeOrder(aliceAcc, aliceWavesPair, BUY, 350, (21.TN / 10.0 * Order.PriceConstant).toLong, matcherFee, orderVersion)
      ...
      "order could be canceled and resubmitted again" in {
        ...
        val order4 = matcherNode.placeOrder(aliceAcc, aliceWavesPair, SELL, 100, 2000.TN, matcherFee, orderVersion)
        order4.status should be("OrderAccepted")
      ...
      "buy order should execute all open orders and put remaining in order book" in {
        ...
        val order5 = matcherNode.placeOrder(bobAcc, aliceWavesPair, BUY, 130, 2000.TN, matcherFee, orderVersion)
      ...
      "should consider UTX pool when checking the balance" in {
        ...
        def bobOrder = matcherNode.prepareOrder(bobAcc, bobWavesPair, SELL, someAssetAmount, 0.005.TN, matcherFee, orderVersion)
        ...
        val order7 = matcherNode.placeOrder(aliceAcc, bobWavesPair, BUY, someAssetAmount, 0.005.TN, matcherFee, orderVersion)
      ...
      "trader can buy TN for assets with order without having TN" in {
        ...
        def bobOrder =
          matcherNode.prepareOrder(bobAcc, bobWavesPair, SELL, someAssetAmount, 1.TN, matcherFee, orderVersion)
